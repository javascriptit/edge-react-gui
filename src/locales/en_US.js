const strings = {
  ...
  activity_navigation_signin_failed_pin_network: 'An error occurred. Please check your network connection. You may also exit PIN login and use your username and password to login offline',
  ...
  fragment_setup_password_nopassword_message: 'Warning. Without a password, you will not be able to login on a new device if this device is lost or stolen, or if this app is uninstalled.',
  fragment_setup_password_nopassword_: 'Warning. Without a password, you will not be able to login on a new device if this device is lost or stolen, or if this app is uninstalled.',
  ...
  fragment_setup_writeitdown_text: 'Your username and password are known only to you and cannot be recovered if forgotten. You WILL lose access to funds if your password is lost.',
  ...
  settings_override_servers_help: 'Warning, this is an advanced setting and may cause your wallet to malfunction. Please restart the app for settings to take affect.',
  fragment_spending_limits_title: 'Spending Limits',
  fragment_spending_limits_warning: '** Warning **\\n\\nSetting a password spending limit may prevent you from accessing funds if your password is forgotten. Please make sure you have setup password recovery',
  fragment_spending_limits_save: 'Save',
  fragment_spending_limits_daily_title: 'Daily Spending Limit',
  fragment_spending_limits_pin_title: 'Require PIN above amount',
  fragment_spending_limits_denomination: 'm฿',
  fragment_spending_limits_hint_text: '0',
  ...
  import_wallet_swept_funds_title: 'Private Key',
  import_wallet_swept_funds_message: 'Private funds have been swept.',
  ...
  fragment_twofactor_menu_scan_message: 'This account has 2 Factor Authentication (2FA) enabled. Scan the 2FA token from the device that enabled 2FA to give access to this device.',
  fragment_twofactor_menu_request_message: 'Request that the Two Factor authentication be turned off. The request will automatically reset in 7 days if no action is taken by the account user on authenticated devices.',
  ...
  fragment_twofactor_show_instruction: 'Enable 2-Factor Authentication to increase security by only allowing logins from previously logged in devices. Add more devices by scanning the QR code below after 2FA is enabled',
  ...
  twofactor_required_message: 'Two Factor Authentication (enchanced security) has been enabled from a different device for this account. Please enable 2 Factor Authentication for full access from this device.',
  twofactor_remind_later: 'Remind Me Later',
  twofactor_enable: 'Enable',
  twofactor_invalid_title: 'Two Factor Invalid',
  twofactor_invalid_message: 'The Two Factor Authentication token on this device is invalid. Either the token was changed by a different device or your clock is skewed. Please check your system time to ensure it is correct.',
  ...
  recovery_answers_corrupt: 'Your account recovery answers are corrupt. You will not be able to recover your account if your password is forgotten. Please login as %1$s and re-setup password recovery. For details, please see our blog post at airbitz.co/go',
  ...
  transaction_footer_import_private_key: 'Import Private Key',
